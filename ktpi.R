...
# ktpi.R jsonmessages --ktpi-function statistic --ktpi-function terrain --ktpi-function ktpi --ktpi-function kaspSlp --ktpi-function kaspDir --ktpi-function kaspSDir --ktpi-function kaspCDir --ktpi-function kaspSlpSDir --ktpi-function kaspSlpCDir --ktpi-function kaspSlpEle2 --ktpi-function kaspSlpEle2SDir --ktpi-function kaspSlpEle2CDir --ktpi-function kaspSlpLnEle --ktpi-function kaspSlpLnEleSlpSDir --ktpi-function kaspSlpLnEleSlpCDir -p ./input/features/ -q ./input/dems/ -a .tif -w 1 -x 14 -y 1 -z 11 -m 1 -n 2000 -d 1 -f 5 -t 20 -s 5 -d 5 -f 20 -t 60 -s 10 -d 10 -f 60 -t 200 -s 20 -d 20 -f 200 -t 600 -s 50 -d 20 -f 600 -t 1000 -s 100 -d 40 -f 1000 -t 2000 -s 200 -o across -o uphill -o downhill -l ./input/limit-tiles.txt -u ./output/ > kc_stat_terr_ktpi_kasp.json
